    ...
    <Layout>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-4xl">
          ...
          {/* Cost & Impact + Testimonial Boxes */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Testimonial */}
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-6 order-1 md:order-2">
              <h3 className="text-lg font-bold text-primary mb-4">What Our Partners Say</h3>
              ...
              <p className="text-sm font-semibold text-primary">— Balaji Narayanan</p>
              <p className="text-xs text-muted-foreground">Program Director</p>
            </div>

            {/* Cost & Impact */}
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-6 order-2 md:order-1">
              <h3 className="text-lg font-bold text-primary mb-4">Cost & Impact</h3>
